...
class NewRaptor:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Raptor creating ')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/raptor_new/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'yeees the second one '),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            QMessageBox.information(self.dlg,"Message 10" ,"Should only first time ")
        
        
        QMessageBox.information(self.dlg,"Message 2" ,"Should every  time ")
        ...
        if missing_layers: #means cheak if missing_layers is not empty 
        ...
        if result:
            ...
            valLong = self.dlg.spbLongitude.value()
            ...
            QMessageBox.information(self.dlg,"Message 4" ,"when OCancel ")
